...
import { COPYRIGHT, LOGOUT_LABEL, NEED_HELP_FOOTER } from '../../helpers/translations';
import { LOGOUT, TNC_LINK, PRIVACY_LINK } from '../../helpers/appConstants';
import supportActions from '../SupportEmail/support.actions';
import { isLoggedIn, token } from '../../helpers/authorization';
...
class FooterRender extends Component {
  ...
  renderFooter() {
    ...
    if (fetchedFooter && footer && footer.length !== 0 && footer.privacyMenu.length !== 0) {
      return (
