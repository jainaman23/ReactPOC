...
import { SEE_MORE, SCENT_TRAINING, COMPLETED_LABEL } from '../../helpers/translations';
          ...
          {moduleListing.levelDetail &&
            <>
              ...
              <div className="progress-wrapper">
                ...
                <p className="progress-count">{levelActivity &&levelActivity.percentageCompleted ? levelActivity.percentageCompleted : 0}% {COMPLETED_LABEL}</p>
              </div>
            </>
          }
        </div>
