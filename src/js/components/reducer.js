...
import {userEdit, userImage, userPass} from './User/Edit/userEdit.reducer';
import {regions, markets, languages, jobtitles, registration, userValidation} from './UserRegistration/userRegistration.reducer';
